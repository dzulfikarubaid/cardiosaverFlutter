...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List imgs = ["icon_lungs.png", "icon_heartrate.png"];

  List rating = ["4.8", "4.7", "4.9"];
                            ...
                            children: [
                              Column(
                                children: [
                                  ...
                                  const Padding(
                                    padding:
                                        EdgeInsets.only(right: 35, bottom: 40),
                                    child: Padding(
                                  ...
                                  Padding(
                                    padding:
                                        EdgeInsets.only(right: 70, bottom: 10),
                                    child: Row(
                                      children: [
                                        Icon(
                                          Icons.warning,
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: const Color.fromARGB(
                                            ...
                                            255,
                                            255,
                                            255), //Color.fromARGB(255, 235, 237, 255),
